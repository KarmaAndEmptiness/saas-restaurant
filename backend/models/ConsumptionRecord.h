...
class ConsumptionRecord
{
  public:
    struct Cols
    {
        ...
        static const std::string _order_items;
     ...
     */
    explicit ConsumptionRecord(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ConsumptionRecord(const Json::Value &pJson) noexcept(false);
     ...
     */
    ConsumptionRecord(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    ///Get the value of the column order_items, returns the default value if the column is null
    const std::string &getValueOfOrderItems() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getOrderItems() const noexcept;
    ///Set the value of the column order_items
    void setOrderItems(const std::string &pOrderItems) noexcept;
    void setOrderItems(std::string &&pOrderItems) noexcept;
    void setOrderItemsToNull() noexcept;
    ...
    void setMemberIdToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<ConsumptionRecord>;
    friend drogon::orm::BaseBuilder<ConsumptionRecord, true, true>;
    friend drogon::orm::BaseBuilder<ConsumptionRecord, true, false>;
    friend drogon::orm::BaseBuilder<ConsumptionRecord, false, true>;
    friend drogon::orm::BaseBuilder<ConsumptionRecord, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ConsumptionRecord>;
#endif
    ...
    std::shared_ptr<std::string> orderItems_;
