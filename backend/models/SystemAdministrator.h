...
class SystemAdministrator
{
  public:
     ...
     */
    explicit SystemAdministrator(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit SystemAdministrator(const Json::Value &pJson) noexcept(false);
     ...
     */
    SystemAdministrator(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    SystemAdministrator() = default;
    ...
    const uint32_t &getValueOfAdminId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint32_t> &getAdminId() const noexcept;
    ///Set the value of the column admin_id
    void setAdminId(const uint32_t &pAdminId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<SystemAdministrator>;
    friend drogon::orm::BaseBuilder<SystemAdministrator, true, true>;
    friend drogon::orm::BaseBuilder<SystemAdministrator, true, false>;
    friend drogon::orm::BaseBuilder<SystemAdministrator, false, true>;
    friend drogon::orm::BaseBuilder<SystemAdministrator, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<SystemAdministrator>;
#endif
    ...
    std::shared_ptr<uint32_t> adminId_;
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where admin_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where admin_id = ?";
        return sql;
    }
