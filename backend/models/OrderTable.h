...
class OrderTable
{
  public:
     ...
     */
    explicit OrderTable(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit OrderTable(const Json::Value &pJson) noexcept(false);
     ...
     */
    OrderTable(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void getUser(const drogon::orm::DbClientPtr &clientPtr,
                 ...
                 const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<OrderTable>;
    friend drogon::orm::BaseBuilder<OrderTable, true, true>;
    friend drogon::orm::BaseBuilder<OrderTable, true, false>;
    friend drogon::orm::BaseBuilder<OrderTable, false, true>;
    friend drogon::orm::BaseBuilder<OrderTable, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<OrderTable>;
#endif
