...
class PermissionCategory
{
  public:
     ...
     */
    explicit PermissionCategory(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PermissionCategory(const Json::Value &pJson) noexcept(false);
     ...
     */
    PermissionCategory(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    PermissionCategory() = default;
    ...
    void getPermissions(const drogon::orm::DbClientPtr &clientPtr,
                        ...
                        const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<PermissionCategory>;
    friend drogon::orm::BaseBuilder<PermissionCategory, true, true>;
    friend drogon::orm::BaseBuilder<PermissionCategory, true, false>;
    friend drogon::orm::BaseBuilder<PermissionCategory, false, true>;
    friend drogon::orm::BaseBuilder<PermissionCategory, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<PermissionCategory>;
#endif
