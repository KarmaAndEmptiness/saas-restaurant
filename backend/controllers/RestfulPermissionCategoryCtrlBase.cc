...
/**
 *
 *  RestfulPermissionCategoryCtrlBase.cc
...
void RestfulPermissionCategoryCtrlBase::getOne(const HttpRequestPtr &req,
                                               ...
                                               PermissionCategory::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<PermissionCategory> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](PermissionCategory r) {
...
void RestfulPermissionCategoryCtrlBase::updateOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  PermissionCategory::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!PermissionCategory::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!PermissionCategory::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void RestfulPermissionCategoryCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  PermissionCategory::PrimaryKeyType &&id)
{
...
void RestfulPermissionCategoryCtrlBase::get(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<PermissionCategory> mapper(dbClientPtr);
    ...
    if(jsonPtr && jsonPtr->isMember("filter"))
    {
        try{
            ...
            mapper.findBy(criteria,
                [req, callbackPtr, this](const std::vector<PermissionCategory> &v) {
                    Json::Value ret;
                    ret.resize(0);
                    for (auto &obj : v)
                    {
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<PermissionCategory> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void RestfulPermissionCategoryCtrlBase::create(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    if(isMasquerading())
    {
        if(!PermissionCategory::validateMasqueradedJsonForCreation(*jsonPtr, masqueradingVector(), err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    {
        if(!PermissionCategory::validateJsonForCreation(*jsonPtr, err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    try 
    {
        PermissionCategory object = 
            (isMasquerading()? 
             PermissionCategory(*jsonPtr, masqueradingVector()) : 
             PermissionCategory(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](PermissionCategory newObject){
...
/*
void RestfulPermissionCategoryCtrlBase::update(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulPermissionCategoryCtrlBase::RestfulPermissionCategoryCtrlBase()
    : RestfulController({
          "category_id",
          "tenant_id",
          "category_name"
